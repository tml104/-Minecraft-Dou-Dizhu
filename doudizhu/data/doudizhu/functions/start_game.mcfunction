...
execute if score sg_temp var matches 3 as @a[tag=Prepared] run function doudizhu:replaceitem_jiao
...
execute if score sg_temp var matches 3 run scoreboard players set #scale score 0
...
execute if score sg_temp var matches 3 run tag @e[tag=doudizhu,tag=Center] add Phase1
