...
execute if score round var matches -1 if entity @s[nbt=!{Inventory:[{Slot:4b,id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"欢迎文字"}'}}}]}] run scoreboard players set @s test_empty 1
...
execute if entity @e[tag=doudizhu,tag=Center,tag=Phase3] if entity @s[nbt=!{Inventory:[{Slot:0b,id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"Pass"}'}}}]}] run scoreboard players set @s test_empty 1
execute if entity @e[tag=doudizhu,tag=Center,tag=Phase3] if entity @s[nbt=!{Inventory:[{Slot:1b,id:"minecraft:carrot_on_a_stick",tag:{display:{Name:'{"text":"叫分"}'}}}]}] run scoreboard players set @s test_empty 1
